...
tinymce.PluginManager.add('textcolor', function(editor) {
	...
	editor.addMenuItem("e_forecolor",{
		text: 'Text Color',
		icon: 'forecolor',
		menu: [{
			type: 'container',
			...
			onclick: function(e){
				this.parent().cancel();
				editor.execCommand('forecolor', false,e.target.getAttribute('data-mce-color'));
			
			}
		}]
	});

	editor.addMenuItem("e_backcolor",{
		...
		menu: [{
			...
			onclick: function (e){
				this.parent().cancel();
				editor.execCommand('hilitecolor', false,e.target.getAttribute('data-mce-color'));
			}
		}]
	});
});
